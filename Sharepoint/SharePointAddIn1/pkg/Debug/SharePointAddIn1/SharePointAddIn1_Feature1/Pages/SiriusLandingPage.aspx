...
<html>
<head>
    <title>Sirius Landing Page</title>
        ...
        <div class="row" style="margin-bottom:10px;">
            <div class="col-md-4">
                 <div id="divUpComingEventTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Up Coming Events</div>
            ...
            <div class="col-md-4">
                <div id="divDepartmentListTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Department List</div>
                    <div style="float:right;padding:5px;width:90px;">
            ...
            <div class="col-md-4">
                <div id="divSiriusNewsTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Sirius New</div>
                    <div style="float:right;padding:5px;width:90px;">
            ...
            <div class="col-md-4 overlaycontainer">
                <div class="overlayimage">
                    <div id="divWeatherNewsTitle" class="webparttitle">
                        <div style="float:left;padding:5px;">Weather New</div>
                        <div style="float:right;padding:5px;width:90px;">
                        </div>
                    </div>
        ...
        <div class="row" style="margin-bottom:10px;">
            <div class="col-md-4">
                <div id="divAnnoucementTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Announcement</div>
                    <div style="float:right;padding:5px;width:90px;">
            ...
            <div class="col-md-4">
                <div id="divSurveyTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Survey</div>
                    <div style="float:right;padding:5px;width:90px;">
            ...
            <div class="col-md-4">
                <div id="divHelpTitle" class="webparttitle">
                    <div style="float:left;padding:5px;">Help</div>
