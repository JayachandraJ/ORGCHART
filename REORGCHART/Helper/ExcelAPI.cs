...
namespace REORGCHART.Helper
{
    public class ExcelAPI
    {
        ...
        public void CreateDataTableFromExcel(string FilePath, DataTable dt)
        {
            using (SpreadsheetDocument spreadSheetDocument = SpreadsheetDocument.Open(FilePath, false))
            {
                ...
                foreach (Row row in rows) //this will also include your header row...
                {
                    ...
                    {
                        tempRow[Idx] = GetCellValue(spreadSheetDocument, row.Descendants<Cell>().ElementAt(Idx - 1));
                    }
        ...
        {
            string RetJSON = "", RetTotalJSON = "", ValJSON = "";
            using (SpreadsheetDocument spreadSheetDocument = SpreadsheetDocument.Open(FilePath, false))
            {
            ...
            return "{ \"data\":[" + RetTotalJSON.Substring(1) + "]}";
        }
