...
namespace REORGCHART.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            MyLastAction myla = LI.GetUserCurrentAction("User");
        ...
        public string SetSelectedValues(string KeyDate, string UsedView, string Country, string ShowLevel, string Levels, string Oper, string Version, string Role,
                                        ...
                                        string SelectedTextColor, string SelectedBorderColor, string SelectedBorderWidth, string SelectedLineColor, string OrgChartType,
                                        string Type)
        {
